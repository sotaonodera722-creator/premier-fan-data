...
const CLUB_PROFILES: Record<number, ClubProfile> = {
  ...
  61: {
    ...
    europeanCups: 2,
    identity:
      "ロンドン西部。1部優勝6回のうち5回は2005年以降で、資本の力で一気に頂点まで上がったクラブの代表格。欧州制覇も2012年と2021年の2回。",
  },
  62: {
    city: "リヴァプール",
    ...
    europeanCups: 0,
    identity:
      "1部優勝9回はリーグ5位。1892年から本拠地だったグディソン・パークを離れ、2025年に新スタジアムへ移った。リヴァプールとの対戦はマージーサイド・ダービーと呼ばれる。",
  },
  63: {
    city: "ロンドン（フラム）",
    venueJa: "クレイヴン・コテージ",
  ...
  71: {
    ...
    europeanCups: 0,
    identity:
      "1部優勝6回は歴代7位だが、すべて1936年以前のもの。ニューカッスルとはタイン・ウィア・ダービーで争う。近年は1部と2部を行き来してきた。",
  },
  73: {
    city: "ロンドン（トッテナム）",
    ...
    europeanCups: 0,
    identity:
      "ビッグ6のなかで唯一プレミアリーグ時代の優勝がなく、1部優勝2回は1961年と1962年。FAカップは8回。2019年に開場した本拠地は欧州でも屈指の設備とされる。",
  },
  322: {
    city: "キングストン・アポン・ハル",
    venueJa: "MKMスタジアム",
  ...
  402: {
    ...
    europeanCups: 0,
    identity:
      "ロンドン西部の小さなクラブ。1部優勝もFAカップ決勝進出もなく、20クラブでもっともタイトルから遠い部類にある。長く親しまれたグリフィン・パークを離れ、新しい本拠地で戦っている。",
  },
  1044: {
    city: "ボーンマス",
